...
```html
<div data-pym-src="http://static.startribune.com/projects/20180422-mnpoll-guns">Loading...</div>
...
```js
{
  "publish": {
    "default": {
      ...
      "path": "news/projects-staging/all/20180422-mnpoll-guns/",
      "url": "http://static.startribune.com/news/projects-staging/all/20180422-mnpoll-guns/"
    },
    "production": {
      "bucket": "static.startribune.com",
      "path": "news/projects/all/20180422-mnpoll-guns/",
      "url": "http://static.startribune.com/news/projects/all/20180422-mnpoll-guns/"
    }
  }
}
```
